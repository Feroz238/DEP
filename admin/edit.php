...

{
    ...
    $query="UPDATE `donor` SET id='$_id',first_name='$first_name',last_name='$last_name',address='$address',phone_number='$phone_number', 
    age='$age',gender='$gender',blood_type='$blood_type',cnic_number='$cnic_number' WHERE id='$id'";

$data=mysqli_query($conn,$query);
if($data)
{
    echo "<script>alert('Wow! User Registration Completed.')</script>";
    header("location:http://localhost/blood/admin/donortable.php");
